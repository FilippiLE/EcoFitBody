package com.example.leandro.myapplication2;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            Log.d("LOGIN ACTIVITY", "4");
            httpCon.setDoOutput(true);
            httpCon.setDoInput(true);
            httpCon.setUseCaches(false);
            httpCon.setRequestProperty( "Content-Type", "application/json" );

            Log.d("LOGIN ACTIVITY", "5");
            ...
            Log.d("LOGIN ACTIVITY", "6");
            try {
                httpCon.connect(); // Note the connect() here
            } catch (IOException e) {
                e.printStackTrace();
            }
            Log.d("LOGIN ACTIVITY", "7");
            ...
            Log.d("LOGIN ACTIVITY", "10");
            try {
                osw.flush();
            } catch (IOException e) {
                e.printStackTrace();
            }
            Log.d("LOGIN ACTIVITY", "11");
            try {
                osw.close();
            } catch (IOException e) {
                e.printStackTrace();
